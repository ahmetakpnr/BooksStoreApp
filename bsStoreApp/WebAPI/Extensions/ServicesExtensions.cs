...
namespace WebAPI.Extensions
{
    ...
    options.UseSqlServer(configuration.GetConnectionString("sqlConnection")));
        ...
        public static void ConfigureHttpCacheHeaders(this IServiceCollection services) =>
            services.AddHttpCacheHeaders(exprationOptions =>
            {
                exprationOptions.MaxAge = 90;
                exprationOptions.CacheLocation = CacheLocation.Public;
            },
            validationOptions =>
            {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(swagger =>
            {
                swagger.SwaggerDoc("v1", 
                    new OpenApiInfo 
                    { 
                        Title = "Demirören Media", 
                        Version = "v1", 
                        Description = "Demirören Media Intern",
                        TermsOfService = new Uri("https://www.demiroren.com.tr/"),
                        Contact = new OpenApiContact
                        {
                            Name = "Ahmet Akpınar",
                            Email = "aakpinar226@gmail.com",
                            Url = new Uri("https://www.ahmetakpinar.com")
                        },
                    });
                swagger.SwaggerDoc("v2", new OpenApiInfo { Title = "Demirören Media", Version = "v2" });
