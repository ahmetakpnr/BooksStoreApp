...
//this class copy-paste from: https://github.com/zcomert/BTK-Akademi-ASPNET-Core-Web-Api/blob/master/bsStoreApp/Entities/Models/Entity.cs
        ...
        private void WriteLinksToXml(string key, object value, XmlWriter writer)
        {
            ...
            if (value.GetType() == typeof(List<Link>))
            {
                foreach (var val in value as List<Link>)
                {
                    ...
                    WriteLinksToXml(nameof(val.hyperReference), val.hyperReference, writer);
